...
<div class="flex justify-center">
    <div class="w-full md:w-8/12 lg:w-6/12 flex">
        <div class="w-8/12 lg:w-6/12 px-5 flex-col items-center md:flex-row">
            <img  class="rounded-lg" src="{{ $user->imagen ? asset('perfiles') . '/' . $user->imagen : asset('img/usuario.svg') }}" alt="Imagen del usuario">
        </div>
